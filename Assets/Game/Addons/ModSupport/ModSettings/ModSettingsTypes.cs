...
namespace DaggerfallWorkshop.Game.Utility.ModSupport.ModSettings
{
    ...
    public class TupleIntKey : Key<Tuple<int, int>>
    {
        ...
        public override int OnEditorWindow(Rect rect, HorizontalCallback horizontal, VerticalCallback vertical, Dictionary<string, object> cache)
        {
            ...
            horizontal(rect, "Value",
                (r) => Value = new Tuple<int, int>(EditorGUI.IntField(r, "First", Value.Item1), Value.Item2),
                (r) => Value = new Tuple<int, int>(Value.Item1, EditorGUI.IntField(r, "Second", Value.Item2)));
            return 1;
        }
#endif
        ...
        {
            return Value.Item1 == value.Item1 && Value.Item2 == value.Item2;
        }
    ...
    public class TupleFloatKey : Key<Tuple<float, float>>
    {
        ...
        public override int OnEditorWindow(Rect rect, HorizontalCallback horizontal, VerticalCallback vertical, Dictionary<string, object> cache)
        {
            ...
            horizontal(rect, "Value",
                (r) => Value = new Tuple<float, float>(EditorGUI.FloatField(r, "First", Value.Item1), Value.Item2),
                (r) => Value = new Tuple<float, float>(Value.Item1, EditorGUI.FloatField(r, "Second", Value.Item2)));
            return 1;
        }
#endif
